...
# ----------------------------------------------------------------------
from src.无用代码.load_data import load_data_set
from src.base.config import creative_id_max, user_id_max, creative_id_step_size
from src.data.show_data import show_result
...
def main():
    ...
    label_name = 'gender'
    no_interval_path = '../../../model/sparsity/no_interval/word2vec/'
    data_file_path = '../../../data/sparsity/no_interval/with_repeat/'
    model_file_path = '../../../model/sparsity/no_interval/with_repeat/'
...
if __name__ == '__main__':
    ...
    # ----------------------------------------------------------------------
    # 定义全局通用变量
    file_name = '../../data/sparsity/train_data_all_sparsity_v.csv'
    model_type = 'MLP'
    RMSProp_lr = 5e-04
    epochs = 10
    batch_size = 256
